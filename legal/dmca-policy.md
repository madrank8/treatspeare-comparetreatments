<!--
  ...
  going live. IMPORTANT: to receive DMCA safe-harbor protection, the designated
  agent must also be registered with the U.S. Copyright Office (dmca.copyright.gov);
  ...
  legal@treatsphere.com, +972-52-6660335
-->
...
3. Identification of the material that is claimed to be infringing and that is to be removed or access to which is to be disabled, with information reasonably sufficient to permit us to locate it — for example, the specific URL(s) on the Site.
