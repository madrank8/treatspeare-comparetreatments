<!--
  ...
  going live. This page is the trust centerpiece of the site; the criteria weights
  below are a sensible default and should be confirmed against actual editorial practice.

  Placeholders used in this file:
  Madrank Digital Ltd, Treatsphere, treatsphere.com, office@madrank.com,
  legal@treatsphere.com
-->
